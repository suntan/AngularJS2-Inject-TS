...
使用步驟 :
1. 請使用 git clone https://github.com/suntan/AngularJS2-Inject-TS.git 指令進行下載到測試目錄之下 , 以下假設是為 /usr/src 資料夾 .

2. 利用 linux 指令變更資料夾名稱 :

[root@/usr/src]# mv AngularJS2-Inject-TS   MyInjectTest <---您喜歡的資料夾名稱
...

{
  ...
  "name": "AngularJS2-Inject-TS", <---- 專案名稱
